...
- [00_cover_letter/](00_cover_letter/)
- [index/](index/)
- [evidence_archive/01_pitch_origin/](evidence_archive/01_pitch_origin/)
- [evidence_archive/02_recovery_and_audit/](evidence_archive/02_recovery_and_audit/)
- [evidence_archive/03_architecture_defense/](evidence_archive/03_architecture_defense/)
- [evidence_archive/04_nightschool_scope/](evidence_archive/04_nightschool_scope/)
- [evidence_archive/05_validation_checkpoints/](evidence_archive/05_validation_checkpoints/)
- [evidence_archive/06_supporting_briefs/](evidence_archive/06_supporting_briefs/)
- a recipient-facing [README_START_HERE.md](README_START_HERE.md)

It intentionally excludes the full packet's [evidence_archive/07_source_provenance/](../master_packet/evidence_archive/07_source_provenance/), which is valuable for internal traceability but heavy for first-pass external review.
...
1. Personalize [00_cover_letter/draft_cover_note.md](00_cover_letter/draft_cover_note.md) in Larry's voice.
...
Only then consider sharing selected materials from [07_source_provenance/](../master_packet/evidence_archive/07_source_provenance/), after a necessity and disclosure review of the exact subfolders involved.
